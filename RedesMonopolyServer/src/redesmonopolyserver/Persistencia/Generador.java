...
public class Generador {
    ...
    public static void GenerarCasillas(Tablero t){
        ...
        cx=-9;
        cy=-40;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Mediterraneo",x,y,"/Imagenes/t1.png");
        t.getCasillas().add(cp);
        x+=vx;
        cc = new CCarta("Arca","Arca Comunal 1",x,y);
        t.getCasillas().add(cc);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Baltica",x,y,"/Imagenes/t3.png");
        t.getCasillas().add(cp);
        x+=vx;
        ci = new CImpuesto(200,"Tax Income",x,y);
        t.getCasillas().add(ci);
        x+=vx;
        cf = new CFerrocarril(-1,"Lectura",x,y,"/Imagenes/t5.png");
        t.getCasillas().add(cf);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Oriental",x,y,"/Imagenes/t6.png");
        t.getCasillas().add(cp);
        x+=vx;
        cc = new CCarta("Fortuna","Fortuna 1",x,y);
        t.getCasillas().add(cc);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Vermont",x,y,"/Imagenes/t8.png");
        t.getCasillas().add(cp);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Connecticut",x,y,"/Imagenes/t9.png");
        t.getCasillas().add(cp);
        x+=vx;
        ...
        cx=58;
        cy=-9;
        cp = new CPropiedad(x+cx,y+cy,"Plaza San Carlos",x,y,"/Imagenes/t11.png");
        t.getCasillas().add(cp);
        y+=vx;
        cs=new CServicios(-1,"Compañia de Electricidad",x,y,"/Imagenes/t12.png");
        t.getCasillas().add(cs);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Status",x,y,"/Imagenes/t13.png");
        t.getCasillas().add(cp);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Virginia",x,y,"/Imagenes/t14.png");
        t.getCasillas().add(cp);
        y+=vx;
        cf = new CFerrocarril(-1,"Pennsylvania",x,y,"/Imagenes/t15.png");
        t.getCasillas().add(cf);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Plaza St. James",x,y,"/Imagenes/t16.png");
        t.getCasillas().add(cp);
        y+=vx;
        cc = new CCarta("Arca","Arca Comunal 2",x,y);
        t.getCasillas().add(cc);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Tennessee",x,y,"/Imagenes/t18.png");
        t.getCasillas().add(cp);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Nueva York",x,y,"/Imagenes/t19.png");
        t.getCasillas().add(cp);
        y+=vx;
        ...
        cx=-10;
        cy=58;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Kentucky",x,y,"/Imagenes/t21.png");
        t.getCasillas().add(cp);
        x+=vx;
        cc = new CCarta("Fortuna","Fortuna 2",x,y);
        t.getCasillas().add(cc);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Indiana",x,y,"/Imagenes/t23.png");
        t.getCasillas().add(cp);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Illinois",x,y,"/Imagenes/t24.png");
        t.getCasillas().add(cp);
        x+=vx;
        cf = new CFerrocarril(-1,"B. & O.",x,y,"/Imagenes/t25.png");
        t.getCasillas().add(cf);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Atlantico",x,y,"/Imagenes/t26.png");
        t.getCasillas().add(cp);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Ventnor",x,y,"/Imagenes/t27.png");
        t.getCasillas().add(cp);
        x+=vx;
        cs=new CServicios(-1,"Compañia de Agua",x,y,"/Imagenes/t28.png");
        t.getCasillas().add(cs);
        x+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Jardines Marvin",x,y,"/Imagenes/t29.png");
        t.getCasillas().add(cp);
        x+=vx;
        ...
        cx=-42;
        cy=-9;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Pacifico",x,y,"/Imagenes/t31.png");
        t.getCasillas().add(cp);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Carolina del Norte",x,y,"/Imagenes/t32.png");
        t.getCasillas().add(cp);
        y+=vx;
        cc = new CCarta("Arca","Arca Comunal 3",x,y);
        t.getCasillas().add(cc);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Avenida Pennsylvania",x,y,"/Imagenes/t34.png");
        t.getCasillas().add(cp);
        y+=vx;
        cf = new CFerrocarril(-1,"Via Rapida",x,y,"/Imagenes/t35.png");
        t.getCasillas().add(cf);
        y+=vx;
        cc = new CCarta("Fortuna","Fortuna 3",x,y);
        t.getCasillas().add(cc);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"Plaza Park",x,y,"/Imagenes/t37.png");
        t.getCasillas().add(cp);
        y+=vx;
        ci = new CImpuesto(200,"Luxury Tax",x,y);
        t.getCasillas().add(ci);
        y+=vx;
        cp = new CPropiedad(x+cx,y+cy,"El Muelle",x,y,"/Imagenes/t39.png");
        t.getCasillas().add(cp);
        y+=vx;
